			...
			<div class="card-body">
				<form:form name="form" id="form" class="form-signup" role="form" modelAttribute="userVO" method="post" action="${pageContext.request.contextPath}/user/insertUser">
					<div class="form-group row">
						<label for="uid" class="col-md-2 col-form-label text-md-right">아이디</label>
						<div class="col-md-3">
					...
					<div class="form-group row">
						<label for="pwd" class="col-md-2 col-form-label text-md-right">비밀번호</label>
						<div class="col-md-3">
					...
					<div class="form-group row">
						<label for="email" class="col-md-2 col-form-label text-md-right">이메일</label>
