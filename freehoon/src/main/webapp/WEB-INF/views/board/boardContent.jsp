...
<script>
	...
	$(document).on('click', '#btnReplySave', function(){
		...
		console.log("reg_id : " + replyReg_id);
		console.log("bid : " + '${boardContent.bid}');
	...
	function showReplyList(){
		...
		$.ajax({
            ...
            success: function(result) {
                ...
                console.log(result);
               	console.log("댓글 갯수 : " + result.length);
	...
	function fn_updateReply(rid, reg_id){
		...
		console.log("content : " + replyEditContent);
