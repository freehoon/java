...
<c:url var="getUserInfoURL" value="/user/getUserInfo">
</c:url>

<c:url var="getUserListURL" value="/user/getUserList">
</c:url>
					...
					<c:choose>
						...
						<c:when test="${!empty userList}">
							<c:forEach var="list" items="${userList}">
								<tr>
									<td>
										<a href="#" onClick="fn_getUserInfo(<c:out value="${list.uid}"/>)" >
